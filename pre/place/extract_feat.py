...
import torch
import torch.backends.cudnn as cudnn  # we use .benchmark
from torch.utils.data import DataLoader
from torch.autograd import Variable
# construct a model with random weights if not (pretrained=True)
# https://pytorch.org/vision/0.8/models.html#id10
# https://pytorch.org/vision/0.8/_modules/torchvision/models/resnet.html#resnet50
# https://colab.research.google.com/github/pytorch/pytorch.github.io/blob/master/assets/hub/pytorch_vision_resnet.ipynb#scrollTo=rjsrt0IrgHzs
from torchvision import models  # resnet50
