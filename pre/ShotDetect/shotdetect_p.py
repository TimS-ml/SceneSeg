...
def main(args, video_path, data_root):
    ...
    try:
        ...
        if args.begin_time is not None:
            ...
            video_manager.set_duration(start_time=start_frame,
                                       end_time=end_frame)
            pass
        ...
        if args.save_keyf_txt:
            output_dir = osp.join(data_root, "shot_txt",
...
if __name__ == '__main__':
    ...
    parser.add_argument('--list_file',
                        type=str,
                        default=osp.join("/mnt/SSD/scene/SceneSeg/data/demo",
                                         "meta/list_test.txt"),
    ...
    for video_id in video_list:
        ...
        pool.apply_async(main,
                         args=(args, video_path, args.save_data_root_path),
                         callback=call_back)
    pool.close()
    pool.join()
