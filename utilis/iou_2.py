...
def run_val(val_path_list):
    '''
    Run validation on a list of videos
    Args:
        val_path_list: List of video's path for validation
    '''
    gt_dict = dict()
    pr_dict = dict()
    shot_to_end_frame_dict = dict()

    for fn in val_path_list:
        print('File path: {}'.format(fn))
